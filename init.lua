...
-- Add file management keys
vim.keymap.set("n", "<Leader>fs", ":w<Enter>", { desc = "Save current file" })
vim.keymap.set("n", "<Leader>ff", ":Sex<Enter>", { desc = "Open file manager" })

-- Make window keys better
